...
public class FXML9Controller implements Initializable {
    ...
    @FXML
    private void load_tenth(ActionEvent event) throws IOException {
         AnchorPane pane10 = FXMLLoader.load(getClass().getResource("10FXML.fxml"));
        rootPane.getChildren().setAll(pane10);
    }
    @FXML
