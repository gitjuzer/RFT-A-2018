...
public class Question5Controller implements Initializable {
    ...
    public void goodAnswerButtonPushed(ActionEvent event) throws IOException{
        Parent Question6Parent = FXMLLoader.load(getClass().getResource("Question6.fxml"));
        Scene Question6Scene = new Scene(Question6Parent);
        
        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(Question6Scene);
        window.show();
    }
    /**
