...
public class Question2Controller implements Initializable {
    ...
    public void wrongAnswerButtonPushed(ActionEvent event) throws IOException{
        Parent wrongAnswerParent = FXMLLoader.load(getClass().getResource("TryAgain2.fxml"));
    ...
    public void goodAnswerButtonPushed(ActionEvent event) throws IOException{
        Parent Question3Parent = FXMLLoader.load(getClass().getResource("Question3.fxml"));
        Scene Question3Scene = new Scene(Question3Parent);
        
        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(Question3Scene);
        window.show();
    }
